...
* **Frontend:** GitHub Pages – push repository as usual and enable Pages in
  Settings.
* **Backend:** Any Node host (Heroku, Railway, Vercel Serverless, etc.) with
  the `server` directory as the entrypoint. Provide environment variables
